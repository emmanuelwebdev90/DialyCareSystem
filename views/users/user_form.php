...
<body>
    ...
    <div class="grid">
        ...
        <section class="user_form">
            ...
            <br>
            <div class="content">
                <form action="<?= $users == '0' ? 'index.php?controller=user&action=create_user' : 'index.php?controller=user&action=update_user' ?> " id="user" method="post">
                    ...
                    <div class="form-content">
                        <div class="group-controls">
                            ...
                            <div class="controls">
                                ...
                                <input required type="text" class="input" id="fullName" value="<?= $users == '0' ? null : $users->nombre_completo ?>" name="nombre_completo">
                            </div>
                        ...
                        <div class="group-controls">
                            ...
                            <div class="controls">
                                ...
                                <input type="email" id="email" " class='input' size=" 90" required name="email" value="<?= $users == '0' ? null : $users->email ?>">
                            </div>
                        ...
                        <div class="group-controls">
                            ...
                            <div class="controls">
                                ...
                                <select required name="rol_id" class="input" id="rol_id">
                                    ...
                                    <option selected hidden value="<?= $users == '0' ? null : $users->rol_id ?>"><?= $users == '0' ? null : $rol->getRoleById($users->rol_id)->nombre ?></option>
                                    <?php
                                    if (isset($roles)):
                        ...
                        <?php endif; ?>
                            ...
                            <div class="controls-group">
                                <div class="group-controls-radio activo">
                                    <label>
                                        <input type="radio" name="activo" value="1" <?=( $users != '0') ? (($users->activo) == 1 ? 'checked' : '') : '' ?>>
                                        <div>
                                            <p>Activo</p>
                                ...
                                <div class="group-controls-radio">
                                    <label>
                                        <input type="radio" name="activo" value="0"  <?=( $users != '0') ? (($users->activo) == 0 ? 'checked' : '') : 'checked' ?>>
                                        <div>
                                            <p>Inativo</p>
        ...
        <section class="action-form">
            <div class="content">
                <?php if ($users != '0'): ?>
                     <button class="button-success" type="submit" form="user"> <i class="fa-solid fa-circle-user"></i> Actualiza Usuario</button>
                <?php else: ?>
                    <button class="button-success" type="submit" form="user"> <i class="fa-solid fa-circle-user"></i> Registrar Usuario</button>
                <?php endif; ?>
            </div>
